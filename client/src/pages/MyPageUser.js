...
const MyPageUser = ({location}) => {
    ...
    const EditUser = () => {
        axios.post(`http://${address}/auth/editProfile`, {
            ...userInfo
        }).then(response => {
            setModal(true)
        }).catch(err => {
    ...
    const handlePost = () => {
        ...
        return axios.post(`http://${address}/auth/upload`, formData)
        ...
        <div id="wrapper">
            <ul
                ...
                <Link
                    ...
                    <div class="sidebar-brand-text mx-3">직원
                    </div>
                </Link>
                ...
                <li class="nav-item active">
                    ...
                    <div
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">직원</h6>
                            <Link class="collapse-item" to="/user/list">직원 목록</Link>
                        </div>
                    </div>
                </li>
                <li class="nav-item">
                ...
                <div id="content">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                ...
                                <div
                                    ...
                                    <Link class="dropdown-item" to="/user/mypage">
                    ...
                    <div class="container-fluid">
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">프로필</h1>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value={userInfo.name} onChange={(v) => setUserInfo({
                                            ...userInfo,
                                            name: v.target.value
                                        })}class="form-control" />
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" readOnly onClick={(v) => setVisibleCalendar(!visibleCalendar)} value={moment(userInfo.dateOfBirth).format("YYYY-MM-DD")} class="form-control"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" onChange={(v) => setUserInfo({
                                            ...userInfo,
                                            phoneNumber: v.target.value
                                        })} value={userInfo.phoneNumber} class="form-control" />
                                    </div>
                                    <div class="form-group">
                                        <div class="small mb-1">주민등록번호</div>
                                        <input type="text" onChange={(v) => setUserInfo({
                                            ...userInfo,
                                            registrationNumber: v.target.value
                                        })} value={userInfo.registrationNumber} class="form-control"/>
                                    </div>
                                    <div class="form-group">
                                        <div class="small mb-1">직무</div>
                                        <input type="text" readOnly value={userInfo.position} class="form-control"/>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        })} value={userInfo.gender} class="form-control"/>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        })} value={userInfo.accountNumber} class="form-control"/>
                                    </div>
                                    <div class="form-group">
                                        <div class="small mb-1">연봉</div>
                                        <input type="text" readOnly value={userInfo.salary} class="form-control"/>
                                    </div>
                                    <div onClick={() => EditUser()}class="d-sm-inline-block btn btn-primary shadow-sm">
                                    수정</div>
                                </div>
                            </div>
                        </div>
