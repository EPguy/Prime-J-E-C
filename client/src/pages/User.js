...
const User = () => {
    ...
    <React.Fragment>
        ...
        <MDBContainer>
                {/* MODAL */}
                <MDBModal isOpen={!(userInfo.emailVerified)}   side  position="top-left">
                <MDBModalHeader>이메일 인증을 해주세요!</MDBModalHeader>
                <MDBModalBody>
                   이메일 인증이 되지 않은 아이디입니다.<br/>
                   이메일 인증을 해주세요.
                </MDBModalBody>
                <MDBModalFooter>
                    <MDBBtn color="secondary" onClick={() => {
                            window.location.replace(`http://${client}/`)
                        }
                    }>닫기</MDBBtn>
                </MDBModalFooter>
                </MDBModal>
                <MDBModal isOpen={!(userInfo.isJoin)}   side  position="top-left">
                <MDBModalHeader>관리자에게 가입승인을 받으세요!</MDBModalHeader>
                <MDBModalBody>
                   가입 승인이 되지 않은 아이디입니다.<br/>
                   관리자에게 문의를 해주세요.
                </MDBModalBody>
                <MDBModalFooter>
                    <MDBBtn color="secondary" onClick={() => {
